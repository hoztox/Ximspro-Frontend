...
const AddSubscriberSuccessModal = ({ showAddSubSuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showAddSubSuccessModal) return null;
    return (
        <AnimatePresence>
            {showAddSubSuccessModal && (
                <motion.div
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">Subscriber Added Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
