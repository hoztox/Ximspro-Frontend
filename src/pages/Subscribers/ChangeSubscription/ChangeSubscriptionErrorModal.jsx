...
const ChangeSubscriptionErrorModal = ({ showChangeSubscriptionErrorModal, onClose }) => {
    const { theme } = useTheme();

    if (!showChangeSubscriptionErrorModal) return null;
    return (
        <AnimatePresence>
            {showChangeSubscriptionErrorModal && (
                <motion.div
