...
const ChangeSubscriptionSuccessModal = ({ showChangeSubscriptionSuccessModal, onClose }) => {
  const { theme } = useTheme();
 
   if (!showChangeSubscriptionSuccessModal) return null;
   return (
     <AnimatePresence>
       {showChangeSubscriptionSuccessModal && (
         <motion.div
         ...
         >
           ...
           >
             ...
             <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
               ...
               <p className="success-messege">Subscriber Plan Changed Successfully</p>
             </div>
           </motion.div>
         </motion.div>
       )}
...
export default ChangeSubscriptionSuccessModal
