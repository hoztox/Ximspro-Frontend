...
const EditSubscriptionErrorModal = ({ showEditSubscriptionErrorModal, onClose }) => {
    const { theme } = useTheme();

    if (!showEditSubscriptionErrorModal) return null;
    return (
        <AnimatePresence>
            {showEditSubscriptionErrorModal && (
                <motion.div
...
export default EditSubscriptionErrorModal
