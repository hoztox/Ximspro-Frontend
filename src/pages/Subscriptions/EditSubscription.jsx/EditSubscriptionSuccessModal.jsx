...
const EditSubscriptionSuccessModal = ({ showEditSubscriptionSuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showEditSubscriptionSuccessModal) return null;
    return (
        <AnimatePresence>
            {showEditSubscriptionSuccessModal && (
                <motion.div
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">Subscription Plan Updated Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
