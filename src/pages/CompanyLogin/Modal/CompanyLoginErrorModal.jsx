...
const CompanyLoginErrorModal = ({ showCompanyLoginErrorModal, onClose, errorMessage }) => {
    const { theme } = useTheme();

    if (!showCompanyLoginErrorModal) return null;
    return (
        <AnimatePresence>
            {showCompanyLoginErrorModal && (
                <motion.div
...
export default CompanyLoginErrorModal