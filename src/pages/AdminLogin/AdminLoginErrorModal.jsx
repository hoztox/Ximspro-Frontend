...
const AdminLoginErrorModal = ({ showAdminLoginErrorModal, onClose }) => {
    const { theme } = useTheme();

    if (!showAdminLoginErrorModal) return null;
    return (
        <AnimatePresence>
            {showAdminLoginErrorModal && (
                <motion.div
                ...
                >
                    ...
                    >
                        ...
                        <div className={`add-cmy-error-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="add-cmy-error-messege">Incorrect Username and Password !</p>
