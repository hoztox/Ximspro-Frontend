...
const AdminLoginSuccessModal = ({ showAdminLoginSuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showAdminLoginSuccessModal) return null;
    return (
        <AnimatePresence>
            {showAdminLoginSuccessModal && (
                <motion.div
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <h1 className="success-messegehead">Welcome Back !</h1>
                            <p className="success-messege">Logged in as Super Admin</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
...
export default AdminLoginSuccessModal
