...
const AddUser = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("Sending data:", dataToSubmit); // Debugging
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex flex-wrap gap-5 mt-3">
              <label className="flex items-center">
                ...
                />
                <span className="permissions-texts cursor-pointer">QMS</span>
              </label>
              <label className="flex items-center">
                <input
                  type="checkbox"
                  ...
                  className="mr-2 form-checkboxes"
                />
                <span className="permissions-texts cursor-pointer">EMS</span>
              </label>
              <label className="flex items-center">
                <input
                  type="checkbox"
                  ...
                  className="mr-2 form-checkboxes"
                />
                <span className="permissions-texts cursor-pointer whitespace-nowrap">OHS</span>
              </label>
              <label className="flex items-center">
                <input
                  type="checkbox"
                  ...
                  className="mr-2 form-checkboxes"
                />
                <span className="permissions-texts cursor-pointer">EnMS</span>
              </label>
              <label className="flex items-center">
                <input
                  type="checkbox"
                  ...
                  className="mr-2 form-checkboxes"
                />
                <span className="permissions-texts cursor-pointer">BMS</span>
              </label>
              <label className="flex items-center">
                <input
                  type="checkbox"
                  ...
                  className="mr-2 form-checkboxes"
                />
                <span className="permissions-texts cursor-pointer">AMS</span>
              </label>
              <label className="flex items-center">
                <input
                  type="checkbox"
                  ...
                  className="mr-2 form-checkboxes"
                />
                <span className="permissions-texts cursor-pointer">IMS</span>
              </label>
            </div>
          </div>
        </div>
