...
const QmsDraftTargets = () => {
    ...
    const handleQmsViewDraftTargets = () => {
        navigate('/company/qms/view-draft-targets')
    }

    const handleQmsEditDraftTargets = () => {
        navigate('/company/qms/edit-draft-targets')
    }

    // Delete target
    const handleDeleteDraftTargets = (id) => {
                        ...
                        {filteredTargets.map((target, index) => (
                            <tr key={target.id} className="border-b border-[#383840] hover:bg-[#1a1a20] h-[50px] cursor-pointer">
                                ...
                                <td className="px-2 add-manual-datas">
                                    <button onClick={handleQmsEditDraftTargets} className='text-[#1E84AF]'>
                                        Click to continue
                                    </button>
                                </td>
                                <td className="px-2 add-manual-datas !text-center">
                                    <button onClick={handleQmsViewDraftTargets}>
