...
const QmsEditNonConformityReport = () => {
    ...
    const fetchSuppliers = async () => {
        try {
            ...
            const ncrResponse = await axios.get(`${BASE_URL}/qms/car-numbers/${id}/`);
            const ncrData = ncrResponse.data;

            if (ncrData.source === 'Supplier') {
                setFormData(prev => ({
                    ...prev,
                    supplier: ncrData.supplier?.id || '' 
                }));
            }
        } catch (err) {
    ...
    return (
        <div className="bg-[#1C1C24] text-white p-5 rounded-lg">
            <div className="flex justify-between items-center border-b border-[#383840] px-[104px] pb-5">
                <h1 className="add-training-head">Edit Non Conformity Reports</h1>
                <button
...
export default QmsEditNonConformityReport
