...
const QmsListInboxSystemMessaging = () => {
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      await axios.patch(
        `${BASE_URL}/qms/messages/trash/${messageToDelete.id}/`,
        {
          user_id: userId,
        }
      );
  ...
  if (loading)
    return (
      <div className="bg-[#1C1C24] text-center not-found p-5 rounded-lg">
        Loading...
      </div>
    );
        ...
        <table className="w-full">
          <thead className="bg-[#24242D]">
            <tr className="h-[48px]">
              ...
              <th className="px-3 text-left list-awareness-training-thead w-[30%]">
                Subject
              </th>
              <th className="px-3 text-left list-awareness-training-thead w-[15%]">
                Date
