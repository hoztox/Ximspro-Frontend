...
const MeetingMinutesSuccessModal = ({ showAddeMinutesSuccessModal, onClose }) => {
  const { theme } = useTheme();
 
     if (!showAddeMinutesSuccessModal) return null;
     return (
         <AnimatePresence>
             {showAddeMinutesSuccessModal && (
                 <motion.div
                 ...
                 >
                     ...
                     >
                         ...
                         <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                             ...
                             <p className="success-messege">Meeting Minutes Added Successfully</p>
                         </div>
                     </motion.div>
                 </motion.div>
             )}
...
export default MeetingMinutesSuccessModal
