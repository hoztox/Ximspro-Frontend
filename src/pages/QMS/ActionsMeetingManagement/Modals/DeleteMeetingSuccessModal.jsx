...
const DeleteMeetingSuccessModal = ({ showDeleteMeetingSuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showDeleteMeetingSuccessModal) return null;
    return (
        <AnimatePresence>
            {showDeleteMeetingSuccessModal && (
                <motion.div
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">Meeting Deleted Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
...
export default DeleteMeetingSuccessModal
