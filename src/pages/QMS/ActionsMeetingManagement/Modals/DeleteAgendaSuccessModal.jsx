...
const DeleteAgendaSuccessModal = ({ showDeleteAgendaSuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showDeleteAgendaSuccessModal) return null;
    return (
        <AnimatePresence>
            {showDeleteAgendaSuccessModal && (
                <motion.div
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">Agenda Deleted Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
...
export default DeleteAgendaSuccessModal
