...
const QmsEditDraftMeeting = () => {
  ...
  const [showEditMeetingSuccessModal, setShowEditMeetingSuccessModal] =
    useState(false);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const dateParts = meetingData.date
          ? meetingData.date.split("-")
          : ["", "", ""];
        const startTimeParts = meetingData.start_time
          ? meetingData.start_time.split(":")
          : ["", ""];
        const endTimeParts = meetingData.end_time
          ? meetingData.end_time.split(":")
          : ["", ""];
        ...
        const agendasResponse = await axios.get(
