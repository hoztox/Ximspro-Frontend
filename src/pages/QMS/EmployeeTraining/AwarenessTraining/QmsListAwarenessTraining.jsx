...
import { Search, Eye, Edit2, Trash2, X, CheckCircle, AlertCircle } from 'lucide-react';
                ...
                <table className="w-full">
                    ...
                    <tbody>
                        {currentItems.length > 0 ? (
                            ...
                            <tr className="h-[50px]">
                                <td colSpan="8" className="px-3 not-found text-center">No awareness training items found</td>
                            </tr>
                        )}
                    </tbody>
                </table>
