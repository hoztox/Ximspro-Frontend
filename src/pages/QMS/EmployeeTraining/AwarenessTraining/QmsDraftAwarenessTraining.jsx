    ...
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(
          `${BASE_URL}/qms/awareness-draft/${id}/`
        );
    ...
    switch (item.category) {
      ...
      case "Presentation":
        return item.upload_file
          ? `File: ${item.upload_file.split("/").pop()}`
          : "No file uploaded";
      default:
        return "";
    }
                ...
                {currentItems.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="px-3 list-awareness-training-datas text-left text-[#1E84AF]">
                      <button
                        onClick={() =>
                          handleEditDraftAwarenessTraining(item.id)
                        }
                      >
                        Click to Continue
                      </button>
                    ...
                    <td className="list-awareness-training-datas text-center">
                      <div className="flex justify-center items-center h-[50px]">
                        <button
                          onClick={() =>
                            handleViewDraftAwarenessTraining(item.id)
                          }
                        >
                          <img
                            src={view}
