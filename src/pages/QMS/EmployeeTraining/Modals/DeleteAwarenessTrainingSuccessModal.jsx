...
const DeleteAwarenessTrainingSuccessModal = ({ showDeleteAwarenessTrainingSuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showDeleteAwarenessTrainingSuccessModal) return null;
    return (
        <AnimatePresence>
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">Awareness Training Deleted Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
...
export default DeleteAwarenessTrainingSuccessModal
