...
const ErrorModal = ({ showErrorModal, onClose, errorMessege, error }) => {
      ...
      {showErrorModal && (
        ...
        >
          ...
          >
            ...
            <div
              className={`add-cmy-error-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"
                }`}
            >
              <img
                src={errors}
              ...
              <p className="add-cmy-error-messege text-center">{errorMessege || error || 'Please try again'}</p>
