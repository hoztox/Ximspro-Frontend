...
const DeleteEmployeePerformanceSuccessModal = ({ showDeleteEmployeePerformanceSuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showDeleteEmployeePerformanceSuccessModal) return null;
    return (
        <AnimatePresence>
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">Employee Performance Deleted Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
...
export default DeleteEmployeePerformanceSuccessModal
