...
const DeleteTrainingEvaluationSuccessModal = ({ showDeleteTrainingEvaluationSuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showDeleteTrainingEvaluationSuccessModal) return null;
    return (
        <AnimatePresence>
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">Training Evaluation Deleted Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
...
export default DeleteTrainingEvaluationSuccessModal
