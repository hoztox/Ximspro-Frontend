...
const DeleteTrainingSuccessModal = ({ showDeleteTrainingSuccessModal, onClose }) => {
 const { theme } = useTheme();
 
   if (!showDeleteTrainingSuccessModal) return null;
   return (
     <AnimatePresence>
       {showDeleteTrainingSuccessModal && (
         <motion.div
         ...
         >
           ...
           >
             ...
             <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
               ...
               <p className="success-messege">Training Deleted Successfully</p>
             </div>
           </motion.div>
         </motion.div>
       )}
...
export default DeleteTrainingSuccessModal
