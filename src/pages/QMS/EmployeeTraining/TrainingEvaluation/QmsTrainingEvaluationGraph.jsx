    ...
    return (
        <div className="p-5 bg-[#1C1C24] text-white rounded-lg">
            ...
            <div className="flex justify-between items-center pt-5">
                ...
                <button className="border border-white px-[10px] w-auto h-[42px] rounded graph-tabs">Add Training Evaluation</button>
                <button className="border border-white px-[10px] w-auto h-[42px] rounded graph-tabs">List Training Evaluation</button>
