    ...
    <div className="p-5 bg-[#1C1C24] text-white rounded-lg">
      ...
      <div className="flex justify-between items-center pt-5 gap-5">
        <div className="relative">
          ...
          >
            <option>Select Employee Performance Evaluation</option>
          </select>
          <ChevronDown
        ...
        <button
          ...
          onClick={() => navigate("/company/qms/add-employee-performance")}
        >
          Add Employee Performance Evaluation <Plus size={18} />
        </button>
        <button
          ...
          <table className="w-full border-collapse mt-4">
            ...
            <tbody>
              {employeeData.map((employee, empIndex) => (
                <tr key={empIndex} className="text-white border-b border-[#383840] h-[54px] ">
                  <td className="text-start px-5 graph-tabs text-[#AAAAAA]">{employee.name}</td>
              ...
              <tr className="text-white border-b border-[#383840] h-[54px]">
                ...
                <td className="text-right graph-tabs text-[#AAAAAA] pr-5">
                  {percentages.reduce((sum, percentage) => sum + parseFloat(percentage), 0).toFixed(0)}%
                </td>
              </tr>
            </tbody>
          </table>
