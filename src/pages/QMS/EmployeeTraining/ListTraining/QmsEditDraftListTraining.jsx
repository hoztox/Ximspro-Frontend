...
useEffect(() => {
    ...
    const handleSubmit = async (e) => {
        ...
        const formattedDatePlanned = formData.date_planned.year && formData.date_planned.month && formData.date_planned.day 
            ? `${formData.date_planned.year}-${formData.date_planned.month}-${formData.date_planned.day}` 
            : '';
            
        const formattedDateConducted = formData.date_conducted.year && formData.date_conducted.month && formData.date_conducted.day 
            ? `${formData.date_conducted.year}-${formData.date_conducted.month}-${formData.date_conducted.day}` 
            : '';
            
        const formattedEvaluationDate = formData.evaluation_date.year && formData.evaluation_date.month && formData.evaluation_date.day 
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="grid grid-cols-3 gap-5">
                        ...
                        <div className="relative">
                            ...
                            <ChevronDown
                                className={`absolute right-3 top-1/3 transform transition-transform duration-300
                                          ${focusedDropdown === "date_planned.day" ? "rotate-180" : ""}`}
                                size={20}
                                color="#AAAAAA"
                            />
                        </div>
                        ...
                        <div className="relative">
                            ...
                            <ChevronDown
                                className={`absolute right-3 top-1/3 transform transition-transform duration-300
                                          ${focusedDropdown === "date_planned.month" ? "rotate-180" : ""}`}
                                size={20}
                                color="#AAAAAA"
                            />
                        </div>
                        ...
                        <div className="relative">
                            ...
                            <ChevronDown
                                className={`absolute right-3 top-1/3 transform transition-transform duration-300
                                          ${focusedDropdown === "date_planned.year" ? "rotate-180" : ""}`}
                                size={20}
                                color="#AAAAAA"
                            />
                        </div>
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="grid grid-cols-3 gap-5">
                                ...
                                <div className="relative">
                                    ...
                                    <ChevronDown
                                        className={`absolute right-3 top-1/3 transform transition-transform duration-300
                                                  ${focusedDropdown === "evaluation_date.day" ? "rotate-180" : ""}`}
                                        size={20}
                                        color="#AAAAAA"
                                    />
                                </div>
                                ...
                                <div className="relative">
                                    ...
                                    <ChevronDown
                                        className={`absolute right-3 top-1/3 transform transition-transform duration-300
                                                  ${focusedDropdown === "evaluation_date.month" ? "rotate-180" : ""}`}
                                        size={20}
                                        color="#AAAAAA"
                                    />
                                </div>
                                ...
                                <div className="relative">
                                    ...
                                    <ChevronDown
                                        className={`absolute right-3 top-1/3 transform transition-transform duration-300
                                                  ${focusedDropdown === "evaluation_date.year" ? "rotate-180" : ""}`}
                                        size={20}
                                        color="#AAAAAA"
                                    />
                                </div>
