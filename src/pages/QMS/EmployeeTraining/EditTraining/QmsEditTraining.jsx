    ...
    useEffect(() => {
        const fetchTrainingData = async () => {
            try {
                ...
                // Format dates
                const date_planned = data.date_planned ? new Date(data.date_planned) : null;
                const date_conducted = data.date_conducted ? new Date(data.date_conducted) : null;
                const evaluation_date = data.evaluation_date ? new Date(data.evaluation_date) : null;
...
export default QmsEditTraining;