...
const QmsAddSupplierProblem = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${BASE_URL}/qms/supplier-problems/`,
        finalSubmissionData
      );
      ...
      setSuccessMessage("Supplier Problem Added Successfully");
    } catch (err) {
  ...
  const handleSaveDraft = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${BASE_URL}/qms/supplier-problems/draft-create/`,
        finalSubmissionData
      );
      ...
      setSuccessMessage("Supplier Problem Drafted Successfully");
    } catch (err) {
