...
const EvaluationModal = ({ isOpen, onClose, supplier, supplierList, evaluationId }) => {
    const [selectedSupplier, setSelectedSupplier] = useState(supplier ? supplier.id || 'Select Supplier' : 'Select Supplier');
                            ...
                            <div className="w-[528px]  ">
                                ...
                                <div className="p-5 pt-6">
                                    <div className="flex relative items-center gap-3">
                                        <label className="block evaluate-modal-head">Select Supplier</label>
                                        <select
...
const QmsSupplierPerformace = () => {
    ...
    // Modal states
    const [evaluationModal, setEvaluationModal] = useState({ isOpen: false, supplier: null });
        ...
        <div className="bg-[#1C1C24] text-white p-5 rounded-lg">
                ...
                <table className="w-full">
                    ...
                    <tbody>
                        {currentItems.length > 0 ? (
                            ...
                            <tr>
                                <td colSpan="10" className="text-center py-4 not-found">No supplier evaluation found</td>
                            </tr>
                        )}
                    </tbody>
                </table>
            ...
            {filteredEvaluations.length > 0 && (
                <div className="flex justify-between items-center mt-3">
                    <div className='text-white total-text'>Total-{filteredEvaluations.length}</div>
