...
const DeleteEmployeeSatisfactionConfirmModal = ({ showDeleteModal, onConfirm, onCancel }) => {
...
export default DeleteEmployeeSatisfactionConfirmModal
