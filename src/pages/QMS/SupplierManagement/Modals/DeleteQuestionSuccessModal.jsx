...
const DeleteQuestionSuccessModal = ({ showDeleteQuestionSuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showDeleteQuestionSuccessModal) return null;
    return (
        <AnimatePresence>
            {showDeleteQuestionSuccessModal && (
                <motion.div
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">Question Deleted Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
...
export default DeleteQuestionSuccessModal
