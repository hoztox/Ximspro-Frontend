...
const DeleteEmployeeSatisfactionSuccessModal = ({ showDeleteEmployeeSatisfactionSuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showDeleteEmployeeSatisfactionSuccessModal) return null;
    return (
        <AnimatePresence>
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">Customer Satisfaction Deleted Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
...
export default DeleteEmployeeSatisfactionSuccessModal
