...
const QmsDraftSignificantEnergy = () => {
    ...
    const handleQmsViewDraftSignificantEnergy = () => {
        navigate('/company/qms/view-draft-significant-energy')
    }

    const handleQmsEditDraftSignificantEnergy = () => {
        navigate('/company/qms/edit-draft-significant-energy')
    }

    // Delete significantEnergies
    const handleDeleteDraftSignificantEnergy = (id) => {
                        ...
                        {filteredSignificantEnergy.map((significantEnergies, index) => (
                            <tr key={significantEnergies.id} className="border-b border-[#383840] hover:bg-[#1a1a20] h-[50px] cursor-pointer">
                                ...
                                <td className="px-2 add-manual-datas">
                                    <button onClick={handleQmsEditDraftSignificantEnergy} className='text-[#1E84AF]'>
                                        Click to Continue
                                    </button>
                                </td>
                                <td className="px-2 add-manual-datas !text-center">
                                    <button onClick={handleQmsViewDraftSignificantEnergy}>
                                ...
                                <td className="px-2 add-manual-datas !text-center">
                                    <button onClick={() => handleDeleteDraftSignificantEnergy(significantEnergies.id)}>
