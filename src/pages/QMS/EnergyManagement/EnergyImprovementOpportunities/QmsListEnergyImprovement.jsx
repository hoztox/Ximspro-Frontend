...
const QmsListEnergyImprovement = () => {
    ...
    const handleQmsViewImprovement = () => {
        navigate('/company/qms/view-energy-improvement-opportunities')
    }

    const handleQmsEditImprovement = () => {
        navigate('/company/qms/edit-energy-improvement-opportunities')
    }
                    ...
                    <tbody>
                        {filteredImprovements.map((improvement, index) => (
                            <tr key={improvement.id} className="border-b border-[#383840] hover:bg-[#1a1a20] h-[50px] cursor-pointer">
                                ...
                                <td className="px-2 add-manual-datas">{improvement.target_date}</td>
                                <td className="px-2 add-manual-datas">{improvement.responsible}</td>
                                <td className="px-2 add-manual-datas !text-center">
                                    <span
                                        className={`inline-block rounded-[4px] px-[6px] py-[3px] text-xs ${improvement.status === 'Achieved'
                                            ? 'bg-[#36DDAE11] text-[#36DDAE]'
                                            : improvement.status === 'OnGoing'
                                ...
                                <td className="px-2 add-manual-datas !text-center">
                                    <button onClick={handleQmsViewImprovement}>
                                ...
                                <td className="px-2 add-manual-datas !text-center">
                                    <button onClick={handleQmsEditImprovement}>
