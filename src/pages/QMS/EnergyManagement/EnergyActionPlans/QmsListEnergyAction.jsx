...
const QmsListEnergyAction = () => {
    const initialData = [
        { id: 1, title: 'Improve product quality', statement: 'Test', date: '03-12-2024', responsible: 'Test' },
        { id: 2, title: 'Reduce production waste', statement: 'Test', date: '03-12-2024', responsible: 'Test' },
        { id: 3, title: 'Implement new testing protocol', statement: 'Test', date: '03-12-2024', responsible: 'Test' },
        { id: 4, title: 'New safety standards', statement: 'Test', date: '04-12-2024', responsible: 'Test' },
    ];
    ...
    const filteredEnergyActions = currentItems.filter(energyAction =>
    ...
    const handleQmsViewEnergyAction = () => {
        // navigate('/company/qms/view-energy-review')
    }

    const handleQmsEditEnergyAction = () => {
        // navigate('/company/qms/edit-energy-review')
    }

    // Delete energyAction
    const handleDeleteEnergyAction = (id) => {
        setEnergyActions(energyActions.filter(energyAction => energyAction.id !== id));
    };
                ...
                <table className="w-full border-collapse">
                    <thead className='bg-[#24242D]'>
                        <tr className="h-[48px]">
                            ...
                            <th className="px-2 text-left add-manual-theads">Statement on Energy Improvement Perfomance</th>
                    ...
                    <tbody>
                        {filteredEnergyActions.map((energyAction, index) => (
                            <tr key={energyAction.id} className="border-b border-[#383840] hover:bg-[#1a1a20] h-[50px] cursor-pointer">
                                ...
                                <td className="px-2 add-manual-datas">{energyAction.responsible}</td>
                                <td className="px-2 add-manual-datas">{energyAction.date}</td>
                                <td className="px-2 add-manual-datas !text-center">
                                    <button onClick={handleQmsViewEnergyAction}>
                                ...
                                <td className="px-2 add-manual-datas !text-center">
                                    <button onClick={handleQmsEditEnergyAction}>
