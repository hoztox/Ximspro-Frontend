...
const QmsDraftAudit = () => {
  const [searchQuery, setSearchQuery] = useState('');
     ...
     const [trainingItems, setTrainingItems] = useState([
         { id: 1, title: 'Anonymous', audit_type: 'Anonymous', date_planned: '03-04-2025', },
         { id: 2, title: 'Anonymous', audit_type: 'Anonymous', date_planned: '03-04-2025', },
     ]);
     ...
     const handleEditDraftAudit = () => {
         navigate('/company/qms/edit-draft-audit')
     }
 
     const handleViewDraftAudit = () => {
         navigate('/company/qms/view-draft-audit')
     }
