...
const QmsEditDraftInspections = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        inspection_type: 'Internal', // Default to Internal
        area: '',
        procedures: [],
    ...
    const handleListDraftInspection = () => {
    ...
    const fetchInspectionData = async () => {
        try {
            ...
            setFormData({
                ...
                inspection_type: inspectionData.inspection_type || 'Internal',
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const proposedDate = formData.proposed_date.year && formData.proposed_date.month && formData.proposed_date.day
                ? `${formData.proposed_date.year}-${formData.proposed_date.month}-${formData.proposed_date.day}`
                : null;

            const dateConducted = formData.date_conducted.year && formData.date_conducted.month && formData.date_conducted.day
    ...
    return (
        <div className="bg-[#1C1C24] text-white p-5 rounded-lg">
            <div className="flex justify-between items-center border-b border-[#383840] px-[104px] pb-5">
                <h1 className="add-training-head">Edit Draft Inspection</h1>
                <button
                    className="border border-[#858585] text-[#858585] rounded w-[140px] h-[42px] list-training-btn duration-200"
                    onClick={handleListDraftInspection}
                >
                    List Draft Inspection
                </button>
            </div>
                    ...
                    {formData.check_inspector && (
                        <div className="flex flex-col mt-3">
                            <div className="flex justify-between items-center mb-2">
                                <h3 className="add-training-label">Internal Inspectors</h3>
                            </div>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="grid grid-cols-3 gap-5">
                        ...
                        <div className="relative">
                            <select
                                name="proposed_date.day"
                                value={formData.proposed_date.day}
                                onChange={handleChange}
                                onFocus={() => setFocusedDropdown("proposed_date.day")}
                                onBlur={() => setFocusedDropdown(null)}
                                className="add-training-inputs appearance-none pr-10 cursor-pointer"
                            >
                            ...
                            <ChevronDown
                                ...
                                ${focusedDropdown === "proposed_date.day" ? "rotate-180" : ""}`}
                                size={20}
                                color="#AAAAAA"
                            />
                        </div>
                        ...
                        <div className="relative">
                            <select
                                name="proposed_date.month"
                                value={formData.proposed_date.month}
                                onChange={handleChange}
                                onFocus={() => setFocusedDropdown("proposed_date.month")}
                                onBlur={() => setFocusedDropdown(null)}
                                className="add-training-inputs appearance-none pr-10 cursor-pointer"
                            >
                            ...
                            <ChevronDown
                                className={`absolute right-3 top-1/3 transform transition-transform duration-300
                                ${focusedDropdown === "proposed_date.month" ? "rotate-180" : ""}`}
                                size={20}
                                color="#AAAAAA"
                            />
                        </div>
                        ...
                        <div className="relative">
                            <select
                                name="proposed_date.year"
                                value={formData.proposed_date.year}
                                onChange={handleChange}
                                onFocus={() => setFocusedDropdown("proposed_date.year")}
                                onBlur={() => setFocusedDropdown(null)}
                                className="add-training-inputs appearance-none pr-10 cursor-pointer"
                            >
                            ...
                            <ChevronDown
                                className={`absolute right-3 top-1/3 transform transition-transform duration-300
                                ${focusedDropdown === "proposed_date.year" ? "rotate-180" : ""}`}
                                size={20}
                                color="#AAAAAA"
                            />
                        </div>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="grid grid-cols-3 gap-5">
                        ...
                        <div className="relative">
                            ...
                            <ChevronDown
                                className={`absolute right-3 top-1/3 transform transition-transform duration-300
                                ${focusedDropdown === "date_conducted.month" ? "rotate-180" : ""}`}
                                size={20}
                                color="#AAAAAA"
                            />
                        </div>
                        ...
                        <div className="relative">
                            ...
                            <ChevronDown
                                className={`absolute right-3 top-1/3 transform transition-transform duration-300
                                ${focusedDropdown === "date_conducted.year" ? "rotate-180" : ""}`}
                                size={20}
                                color="#AAAAAA"
                            />
                        </div>
                ...
                <div className="flex flex-col gap-5">
                    <div className="flex flex-col gap-3">
                        ...
                        <textarea
                            ...
                            onChange={handleChange}
                            className="add-training-inputs h-24"
                        />
                    </div>
                </div>
...
export default QmsEditDraftInspections;