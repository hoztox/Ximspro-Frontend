  ...
  return (
    <div className="bg-[#1C1C24]">
      <div className="flex justify-between items-center add-user-header">
        <h1 className="add-user-text">Add Employee</h1>
        <button
          ...
          <div>
            ...
            <div className="relative">
              <select
                ...
                className="w-full add-user-inputs appearance-none cursor-pointer"
              >
