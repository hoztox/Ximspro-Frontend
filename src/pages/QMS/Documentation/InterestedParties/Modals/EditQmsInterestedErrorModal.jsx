...
const EditQmsInterestedErrorModal = ({ showEditQmsInterestedErrorModal, onClose, error }) => {
    const { theme } = useTheme();

    if (!showEditQmsInterestedErrorModal) return null;
    return (
        <AnimatePresence>
            {showEditQmsInterestedErrorModal && (
                <motion.div
...
export default EditQmsInterestedErrorModal
