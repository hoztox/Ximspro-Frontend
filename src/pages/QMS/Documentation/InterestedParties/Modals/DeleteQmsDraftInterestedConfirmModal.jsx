...
const DeleteQmsDraftInterestedConfirmModal =({ showDeleteInterestedDraftModal, onConfirm, onCancel }) => {
  const { theme } = useTheme();

  return (
    <AnimatePresence>
      {showDeleteInterestedDraftModal && (
        <motion.div
          ...
          >
            ...
            >
              <div className="flex justify-center">
                <img
                  src={deleteIllustrate}
                  alt="Delete"
                  className="w-[267px] h-[163px]"
                />
              </div>
              <h3 className="confirmations">
                Are you sure you want to delete
                <br />
                this Drafted Interested Parties?
              </h3>
              <div
...
export default DeleteQmsDraftInterestedConfirmModal;
