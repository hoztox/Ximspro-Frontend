...
const EditQmsInterestedDraftErrorModal = ({ showEditDraftInterestedErrorModal, onClose, error }) => {
    const { theme } = useTheme();

    if (!showEditDraftInterestedErrorModal) return null;
    return (
        <AnimatePresence>
...
export default EditQmsInterestedDraftErrorModal
