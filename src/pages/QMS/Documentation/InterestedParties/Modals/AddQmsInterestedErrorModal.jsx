...
const AddQmsInterestedErrorModal =  ({ showAddQmsInterestedErrorModal, onClose, error }) => {
    const { theme } = useTheme();

    if (!showAddQmsInterestedErrorModal) return null;
    return (
        <AnimatePresence>
            {showAddQmsInterestedErrorModal && (
                <motion.div
...
export default AddQmsInterestedErrorModal
