...
const EditQmsInterestedDraftSuccessModal = ({ showEditDraftInterestedSuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showEditDraftInterestedSuccessModal) return null;
    return (
        <AnimatePresence>
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">Interested Parties Saved Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
...
export default EditQmsInterestedDraftSuccessModal
