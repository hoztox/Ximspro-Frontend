...
const EditQmsInterestedSuccessModal = ({ showEditInterestedSuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showEditInterestedSuccessModal) return null;
    return (
        <AnimatePresence>
            {showEditInterestedSuccessModal && (
                <motion.div
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">Interested Parties Updated Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
...
export default EditQmsInterestedSuccessModal
