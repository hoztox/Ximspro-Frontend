...
const DeleteQmsDraftInterestedErrorModal = ({ showDeleteDraftInterestedErrorModal, onClose, error }) => {
  const { theme } = useTheme();

  if (!showDeleteDraftInterestedErrorModal) return null;
  return (
    <AnimatePresence>
...
export default DeleteQmsDraftInterestedErrorModal;
