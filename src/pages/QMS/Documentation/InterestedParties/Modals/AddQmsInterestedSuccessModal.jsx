...
const AddQmsInterestedSuccessModal = ({ showAddManualSuccessModal, onClose }) => {
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">Interested Parties Added Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
...
export default AddQmsInterestedSuccessModal
