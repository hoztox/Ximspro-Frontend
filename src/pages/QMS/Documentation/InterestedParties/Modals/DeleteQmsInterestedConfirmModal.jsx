...
const DeleteQmsInterestedConfirmModal = ({ showDeleteInterestedModal, onConfirm, onCancel }) => {
    const { theme } = useTheme();

    return (
        <AnimatePresence>
            {showDeleteInterestedModal && (
                <motion.div
...
export default DeleteQmsInterestedConfirmModal
