...
const AddQmsInterestedDraftSuccessModal =({ showDraftInterestedSuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showDraftInterestedSuccessModal) return null;
    return (
        <AnimatePresence>
            {showDraftInterestedSuccessModal && (
                <motion.div
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">Interested Parties Drafted Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
...
export default AddQmsInterestedDraftSuccessModal
