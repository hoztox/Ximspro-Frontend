...
const DeleteQmsInterestedSuccessModal = ({ showDeleteInterestedSuccessModal, onClose }) => {
   const { theme } = useTheme();
  
      if (!showDeleteInterestedSuccessModal) return null;
      return (
          <AnimatePresence>
                  ...
                  >
                      ...
                      >
                          ...
                          <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                              ...
                              <p className="success-messege">Interested Parties Deleted Successfully</p>
                          </div>
                      </motion.div>
                  </motion.div>
              )}
...
export default DeleteQmsInterestedSuccessModal
