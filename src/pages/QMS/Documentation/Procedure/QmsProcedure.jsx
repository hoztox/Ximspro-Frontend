    ...
    const fetchAllData = async () => {
      try {
        ...
        const correctionsPromises = sortedManuals.map(async (manual) => {
          try {
            const correctionResponse = await axios.get(`${BASE_URL}/qms/procedure/${manual.id}/corrections/`);
        ...
        const draftResponse = await axios.get(`${BASE_URL}/qms/procedure/drafts-count/${id}/`);
