...
const DraftQmsProcedure = () => {
    ...
    const handleConfirmDelete = () => {
        if (manualToDelete) {
            axios
                .delete(`${BASE_URL}/qms/procedure-detail/${manualToDelete}/`)
                .then((response) => {
    ...
    const fetchManuals = async () => {
        try {
            ...
            const response = await axios.get(`${BASE_URL}/qms/procedure-draft/${id}/`);
    ...
    return (
        <div className="bg-[#1C1C24] list-manual-main">
            ...
            <div className="flex items-center justify-between px-[14px] pt-[24px]">
                <h1 className="list-manual-head">Draft Procedures</h1>
