...
const DeleteQmsDraftProcessesErrorModal = ({ showDeleteDraftProcessesErrorModal, onClose, error }) => {
 const { theme } = useTheme();
 
   if (!showDeleteDraftProcessesErrorModal) return null;
   return (
     <AnimatePresence>
...
export default DeleteQmsDraftProcessesErrorModal
