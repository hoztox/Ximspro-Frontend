...
const DeleteQmsProcessesSuccessModal = ({ showDeleteProcessesSuccessModal, onClose }) => {
  const { theme } = useTheme();
    
        if (!showDeleteProcessesSuccessModal) return null;
        return (
            <AnimatePresence>
                {showDeleteProcessesSuccessModal && (
                    <motion.div
                    ...
                    >
                        ...
                        >
                            ...
                            <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                                ...
                                <p className="success-messege">Processes Deleted Successfully</p>
                            </div>
                        </motion.div>
                    </motion.div>
                )}
...
export default DeleteQmsProcessesSuccessModal
