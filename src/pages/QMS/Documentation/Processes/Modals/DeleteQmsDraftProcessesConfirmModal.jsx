...
const DeleteQmsDraftProcessesConfirmModal = ({ showDeleteProcessesDraftModal, onConfirm, onCancel }) => {
 const { theme } = useTheme();
 
   return (
     <AnimatePresence>
       {showDeleteProcessesDraftModal && (
         <motion.div
...
export default DeleteQmsDraftProcessesConfirmModal
