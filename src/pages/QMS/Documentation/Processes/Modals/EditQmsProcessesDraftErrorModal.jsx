...
const EditQmsProcessesDraftErrorModal =  ({ showEditDraftProcessesErrorModal, onClose, error }) => {
  const { theme } = useTheme();
 
     if (!showEditDraftProcessesErrorModal) return null;
     return (
         <AnimatePresence>
...
export default EditQmsProcessesDraftErrorModal
