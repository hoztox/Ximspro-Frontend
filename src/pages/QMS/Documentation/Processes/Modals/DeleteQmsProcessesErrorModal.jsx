...
const DeleteQmsProcessesErrorModal = ({ showDeleteProcessesErrorModal, onClose, error }) => {
  const { theme } = useTheme();
  
      if (!showDeleteProcessesErrorModal) return null;
      return (
          <AnimatePresence>
              {showDeleteProcessesErrorModal && (
                  <motion.div
...
export default DeleteQmsProcessesErrorModal
