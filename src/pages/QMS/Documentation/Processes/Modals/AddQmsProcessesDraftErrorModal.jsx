...
const AddQmsProcessesDraftErrorModal = ({ showDraftProcessesErrorModal, onClose, error }) => {
  const { theme } = useTheme();
   
       if (!showDraftProcessesErrorModal) return null;
       return (
           <AnimatePresence>
               {showDraftProcessesErrorModal && (
                   <motion.div
...
export default AddQmsProcessesDraftErrorModal
