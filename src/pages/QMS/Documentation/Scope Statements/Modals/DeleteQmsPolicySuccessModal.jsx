...
const DeleteQmsPolicySuccessModal = ({ showDeleteSuccessModal, onClose }) => {
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">Scope Statement Deleted Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
...
export default DeleteQmsPolicySuccessModal
