...
const EditQmsPolicySuccessModal = ({ showEditPolicySuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showEditPolicySuccessModal) return null;
    return (
        <AnimatePresence>
            {showEditPolicySuccessModal && (
                <motion.div
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">Scope Statement Updated Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
...
export default EditQmsPolicySuccessModal
