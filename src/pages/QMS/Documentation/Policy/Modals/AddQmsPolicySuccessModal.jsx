...
const AddQmsPolicySuccessModal = ({ showAddPolicySuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showAddPolicySuccessModal) return null;
    return (
        <AnimatePresence>
            {showAddPolicySuccessModal && (
                <motion.div
...
export default AddQmsPolicySuccessModal
