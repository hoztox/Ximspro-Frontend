...
const QmsDraftHealthSafetyRiskAssessments = () => {
    ...
    const handleCloseEvaluationComplianceDraft = () => {
        navigate('/company/qms/list-health-safety-assessments');
    };
    const handleView = (id) => {
        navigate(`/company/qms/view-draft-health-safety-assessments/${id}`);
    };
    return (
        <div className="bg-[#1C1C24] list-manual-main">
            ...
            <div className="flex items-center justify-between px-[14px] pt-[24px]">
                <h1 className="list-manual-head">Draft Health and Safety Risk Assessments</h1>
                ...
                <div className="flex space-x-5 items-center">
                    ...
                    <button
                        ...
                        onClick={handleCloseEvaluationComplianceDraft}
                    >
                    ...
                    <table className="w-full">
                        ...
                        <tbody key={currentPage}>
                            {paginatedManual.length > 0 ? (
                                ...
                                <tr><td colSpan="11" className="text-center py-4 not-found">No Draft Sustainability found.</td></tr>
                            )}
...
export default QmsDraftHealthSafetyRiskAssessments
