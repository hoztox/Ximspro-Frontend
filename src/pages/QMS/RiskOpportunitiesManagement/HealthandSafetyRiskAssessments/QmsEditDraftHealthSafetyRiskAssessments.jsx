...
const QmsEditDraftHealthSafetyRiskAssessments = () => {
  ...
  const fetchManualDetails = async () => {
    try {
      ...
      console.error(
        "Error fetching health and safety risk assessments details:",
        err
      );
      setError("Failed to load health and safety risk assessments details");
  ...
  const handleListDraftHealthSafetyAssessments = () => {
    navigate("/company/qms/draft-health-safety-assessments");
  };
  ...
  const handleUpdateClick = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `${BASE_URL}/qms/assessment/create/${id}/`,
        submitData,
        {
          headers: {
    ...
    <div className="bg-[#1C1C24] rounded-lg text-white p-5">
      <div className="flex justify-between items-center border-b border-[#383840] px-[124px] pb-5">
        <h1 className="add-training-head">
          Edit Draft Health and Safety Risk Assessments
        </h1>
        <button
          className="border border-[#858585] text-[#858585] rounded px-3 h-[42px] list-training-btn duration-200"
          onClick={handleListDraftHealthSafetyAssessments}
        >
          List Draft Health and Safety Risk Assessments
        </button>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-5">
          ...
          <div>
            ...
            <input
              ...
              className="w-full add-qms-manual-inputs"
            />
            {fieldErrors.assessment_no && (
              <p className={errorTextClass}>{fieldErrors.assessment_no}</p>
            )}
          </div>
...
export default QmsEditDraftHealthSafetyRiskAssessments;
