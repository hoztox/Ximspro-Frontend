...
const QmsEditDraftHealthSafetyRiskAssessments = () => {
    ...
    const validateForm = () => {
        ...
        if (!formData.assessment_no.trim()) {
            newErrors.assessment_no = 'Section Number is required';
            isValid = false;
        }
    ...
    const handleUpdateClick = async () => {
        ...
        try {
            ...
            const response = await axios.put(`${BASE_URL}/qms/assessment/create/${id}/`, submitData, {
                headers: {
    ...
    return (
        <div className="bg-[#1C1C24] rounded-lg text-white p-5">
            <div className="flex justify-between items-center border-b border-[#383840] px-[124px] pb-5">
                <h1 className="add-training-head">Edit Draft Health and Safety Risk Assessments</h1>
                <button
