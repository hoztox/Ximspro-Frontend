...
const QmsViewDraftHealthSafetyRiskAssessments = () => {
    ...
    return (
        <div className="bg-[#1C1C24] p-5 rounded-lg">
            <div className='flex justify-between items-center border-b border-[#383840] pb-[26px]'>
                <h1 className='viewmanualhead'>Health and Safety Risk Assessments Information</h1>
            ...
            <div className="mt-5">
                <div className="grid grid-cols-2 divide-x divide-[#383840] pb-5">
                    <div className="grid grid-cols-1 gap-[40px]">
                        <div>
                            <label className="viewmanuallabels">Risk Assessment Name/Title</label>
                        ...
                        <div>
                            <label className="viewmanuallabels">Relate Record/ Document</label>
...
export default QmsViewDraftHealthSafetyRiskAssessments
