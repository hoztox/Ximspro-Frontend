...
const ReviewSubmitSuccessModal = ({ showSubmitManualSuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showSubmitManualSuccessModal) return null;
    return (
        <AnimatePresence>
            {showSubmitManualSuccessModal && (
                <motion.div
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">Health and Safety Risk Assessments Submitted Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
