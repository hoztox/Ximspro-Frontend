...
const AddQmsManualDraftErrorModal = ({ showDraftManualErrorModal, onClose, error }) => {
    const { theme } = useTheme();

    if (!showDraftManualErrorModal) return null;
    return (
        <AnimatePresence>
            {showDraftManualErrorModal && (
                <motion.div
...
export default AddQmsManualDraftErrorModal
