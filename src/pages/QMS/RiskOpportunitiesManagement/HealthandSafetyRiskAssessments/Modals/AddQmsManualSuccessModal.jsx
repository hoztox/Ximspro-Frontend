...
const AddQmsManualSuccessModal = ({ showAddManualSuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showAddManualSuccessModal) return null;
    return (
        <AnimatePresence>
            {showAddManualSuccessModal && (
                <motion.div
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">Health and Safety Risk Assessments Added Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
...
export default AddQmsManualSuccessModal
