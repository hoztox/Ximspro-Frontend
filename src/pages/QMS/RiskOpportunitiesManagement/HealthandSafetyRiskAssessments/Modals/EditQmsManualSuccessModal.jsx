...
const EditQmsManualSuccessModal = ({ showEditManualSuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showEditManualSuccessModal) return null;
    return (
        <AnimatePresence>
            {showEditManualSuccessModal && (
                <motion.div
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">Health and Safety Risk Assessments Updated Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
...
export default EditQmsManualSuccessModal
