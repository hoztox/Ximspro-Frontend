...
const AddQmsManualDraftSuccessModal = ({ showDraftManualSuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showDraftManualSuccessModal) return null;
    return (
        <AnimatePresence>
            {showDraftManualSuccessModal && (
                <motion.div
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">Health and Safety Risk Assessments Drafted Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
...
export default AddQmsManualDraftSuccessModal
