...
const EditDraftQmsManualSuccessModal = ({ showEditDraftManualSuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showEditDraftManualSuccessModal) return null;
    return (
        <AnimatePresence>
            {showEditDraftManualSuccessModal && (
                <motion.div
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">Health and Safety Risk Assessments Saved Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
...
export default EditDraftQmsManualSuccessModal
