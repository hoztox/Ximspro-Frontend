...
const DeleteQmsManualDraftSucessModal = ({ showDeleteDraftManualSuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showDeleteDraftManualSuccessModal) return null;
    return (
        <AnimatePresence>
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">Health and Safety Risk Assessments Deleted Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
...
export default DeleteQmsManualDraftSucessModal
