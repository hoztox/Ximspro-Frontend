...
const QmsDraftOpportunityAssessments = () => {
  ...
  const handleViewDraftAssessment = (id) => {
    navigate(`/company/qms/view-draft-opportunity-assessment/${id}`);
  };

  const handleEditDraftOpportunityAssessment = (id) => {
  ...
  if (loading) {
    return (
      <div className="bg-[#1C1C24] not-found p-5 rounded-lg flex justify-center items-center">
        <p>Loading Draft Opportunity Assessments...</p>
      </div>
    );
  }
  ...
  return (
    <div className="bg-[#1C1C24] text-white p-5 rounded-lg">
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className="list-manual-head">Draft Opportunity Assessments</h1>
              ...
              filteredAssessments.map((assessment, index) => (
                ...
                >
                  ...
                  <td className="px-2 add-manual-datas !text-center">
                    <button 
                    onClick={()=>handleEditDraftOpportunityAssessment()}
                    className="text-[#1E84AF]">
                      Click to Continue
                    </button>
                  </td>
                  <td className="px-2 add-manual-datas !text-center">
                    <button onClick={() => handleViewDraftAssessment(assessment.id)}>
                      <img
                        src={viewIcon}
                        alt="View Icon"
                        style={{
...
export default QmsDraftOpportunityAssessments;
