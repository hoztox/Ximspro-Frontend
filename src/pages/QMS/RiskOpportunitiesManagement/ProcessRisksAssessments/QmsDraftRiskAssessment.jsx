...
const QmsDraftRiskAssessment = () => {
 ...
 const fetchAssessments = async () => {
   try {
     ...
     const response = await fetch(`${BASE_URL}/qms/process-draft-risk-assessment/company/${companyId}/`);
   ...
   const handleDeleteRiskAssessment = async (assessment) => {
     ...
     try {
       const response = await fetch(`/api/process-risk-assessments/${assessment.id}/`, {
         method: 'DELETE',
         headers: {
