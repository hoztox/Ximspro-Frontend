...
const QmsEditEnvironmentalWasteManagement = () => {
    ...
    if (manualDetails) {
      setFormData({
        ...
        send_notification_to_checked_by:
          manualDetails.send_notification_to_checked_by || true,
        send_email_to_checked_by:
          manualDetails.send_email_to_checked_by || true,
        send_notification_to_approved_by:
          manualDetails.send_notification_to_approved_by || true,
        send_email_to_approved_by:
          manualDetails.send_email_to_approved_by || true,
      });
    }
  }, [manualDetails]);
  ...
  const fetchManualCorrections = async () => {
    try {
      const response = await axios.get(
        `${BASE_URL}/qms/waste/${id}/corrections/`
      );
      ...
      <div>
        <div className="flex items-center justify-between px-[65px] 2xl:px-[122px]">
          <h1 className="add-manual-sections !px-0">
            Edit Environmental Waste Management
          </h1>
          <button
          ...
          <div className="grid md:grid-cols-2 gap-5">
            <div>
              ...
              {fieldErrors.location && (
                <p className={errorTextClass}>{fieldErrors.location}</p>
              )}
            </div>
            ...
            <div>
              <label className="add-qms-manual-label">WMP No</label>
              <input
                type="text"
                name="wmp"
                value={formData.wmp}
            ...
            <div>
              <label className="add-qms-manual-label">Waste Category</label>
              <div className="relative">
                <select
                  className="w-full add-qms-manual-inputs appearance-none cursor-pointer"
                  name="waste_category"
                ...
                <ChevronDown
                  className={`absolute right-3 top-7 h-4 w-4 text-gray-400 transition-transform duration-300 ease-in-out ${
                    openDropdowns.waste_category ? "rotate-180" : ""
                  }`}
                />
              </div>
            </div>
            ...
            <div>
              <label className="add-qms-manual-label">Waste Handling</label>
              <div className="relative">
                <select
                  className="w-full add-qms-manual-inputs appearance-none cursor-pointer"
                  name="waste_handling"
                ...
                <ChevronDown
                  className={`absolute right-3 top-7 h-4 w-4 text-gray-400 transition-transform duration-300 ease-in-out ${
                    openDropdowns.waste_handling ? "rotate-180" : ""
                  }`}
                />
              </div>
            </div>
            ...
            <div>
              <label className="add-qms-manual-label">Waste Minimization</label>
              <div className="relative">
                <select
                  className="w-full add-qms-manual-inputs appearance-none cursor-pointer"
                  ...
                  onChange={(e) =>
                    handleDropdownChange(e, "waste_minimization")
                  }
                  onBlur={() =>
                    setOpenDropdowns((prev) => ({
                      ...prev,
                ...
                <ChevronDown
                  className={`absolute right-3 top-7 h-4 w-4 text-gray-400 transition-transform duration-300 ease-in-out ${
                    openDropdowns.waste_minimization ? "rotate-180" : ""
                  }`}
                />
              </div>
            </div>
            ...
            <div>
              <label className="add-qms-manual-label">Originator</label>
              <input
                type="text"
                name="originator"
            ...
            <div>
              <label className="add-qms-manual-label">Responsible Party</label>
              <input
                type="text"
            ...
            <div>
              <label className="add-qms-manual-label">Waste Type</label>
              <input
                type="text"
                name="waste_type"
            ...
            <div>
              <label className="add-qms-manual-label">Remark</label>
              <textarea
                name="remark"
