...
const QmsDraftEditEnvironmentalWasteManagement = () => {
    ...
    const handleDraftSustainability = () => {
        navigate('/company/qms/draft-environmantal-waste-management');
    }
            ...
            <div>
                <div className='flex items-center justify-between  px-[65px] 2xl:px-[122px]'>
                    ...
                    <button
                        ...
                        onClick={handleDraftSustainability}
                    >
                        <span>List Draft Environmental Waste Management</span>
                    </button>
                </div>
...
export default QmsDraftEditEnvironmentalWasteManagement
