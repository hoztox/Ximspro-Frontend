...
const QmsListEnvironmentalWasteManagement = () => {
    ...
    const fetchManuals = async () => {
        try {
            ...
            const response = await axios.get(`${BASE_URL}/qms/waste/${companyId}/`);
    ...
    useEffect(() => {
        ...
        const fetchAllData = async () => {
            try {
                ...
                const manualsResponse = await axios.get(`${BASE_URL}/qms/waste/${companyId}/`);
                ...
                const draftResponse = await axios.get(`${BASE_URL}/qms/waste/drafts-count/${id}/`);
    ...
    const handleClickApprove = (id) => {
        navigate(`/company/qms/view-environmantal-waste-management/${id}`);
    };
    ...
    const handleConfirmDelete = async () => {
        if (manualToDelete) {
            try {
                await axios.delete(`${BASE_URL}/qms/waste-detail/${manualToDelete}/`);
    ...
    const handleQMSAddEvaluationCompliance = () => {
        navigate('/company/qms/add-environmantal-waste-management');
    };
    ...
    const handlePublishSave = async () => {
        try {
            ...
            await axios.post(`${BASE_URL}/qms/waste/${selectedManualId}/publish-notification/`, {
            ...
            <div className="flex items-center justify-between px-[14px] pt-[24px]">
                ...
                <div className="flex space-x-5">
                    ...
                    >
                        <span>Drafts</span>
                        {draftCount > 0 && (
                            <span className="bg-red-500 text-white rounded-full text-xs flex justify-center items-center w-[20px] h-[20px] absolute top-[120px] right-[342px]">
                                {draftCount}
                            </span>
                        )}
                    </button>
                    ...
                    >
                        <span>Add Environmental Waste Management</span>
                    ...
                    <table className="w-full">
                        <thead className='bg-[#24242D]'>
                            <tr className="h-[48px]">
                                ...
                                <th className="px-2 text-left add-manual-theads">Waste Type</th>
                        ...
                        <tbody key={currentPage}>
                            {paginatedManual.length > 0 ? (
                                ...
                                <tr><td colSpan="11" className="text-center py-4 not-found">No Environmental Waste Management Found.</td></tr>
                            )}
                            <tr>
...
export default QmsListEnvironmentalWasteManagement
