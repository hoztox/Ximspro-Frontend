...
const QmsViewEnvironmentalAspect = () => {
                ...
                Object.keys(localStorage)
                    ...
                    .forEach((key) => {
                        ...
                        try {
                            ...
                            companyData[cleanKey] = localStorage.getItem
    ...
    const fetchAspectDetails = async () => {
        try {
            const response = await axios.get(`${BASE_URL}/qms/environmental-aspect-detail/${id}/`);
    ...
    const fetchAspectCorrections = async () => {
        try {
            const response = await axios.get(`${BASE_URL}/qms/environmental-aspect/${id}/corrections/`);
    ...
    const handleCorrectionSubmit = async () => {
        try {
            ...
            const response = await axios.post(
                `${BASE_URL}/qms/environmental-aspect/submit-correction/`,
                requestData
            );
    ...
    const handleDelete = async () => {
        try {
            await axios.delete(`${BASE_URL}/qms/environmental-aspect-detail/${id}/`);
            navigate("/company/qms/list-environmantal-aspect");
        } catch (error) {
    ...
    const isCurrentUserWrittenBy = currentUserId === formData.written_by?.id;
    ...
    const canReview = (() => {
        ...
        if (formData.status === "Pending for Review/Checking") {
            return currentUserId === formData.checked_by?.id;
        }
        ...
        if (formData.status === "Reviewed,Pending for Approval") {
            return currentUserId === formData.approved_by?.id;
        }
        return false;
    })();
    ...
    const handleReviewAndSubmit = async () => {
        try {
            ...
            const response = await axios.post(
                `${BASE_URL}/qms/environmental-aspect-review/`,
                requestData
            );
    ...
    if (!formData) return <div className="text-white">No aspect details found</div>;
