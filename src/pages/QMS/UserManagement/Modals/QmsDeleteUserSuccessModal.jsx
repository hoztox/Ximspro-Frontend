...
const QmsDeleteUserSuccessModal = ({ showDeleteUserSuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showDeleteUserSuccessModal) return null;
    return (
        <AnimatePresence>
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">User Deleted Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
...
export default QmsDeleteUserSuccessModal
