...
const QmsEditUserSuccessModal = ({ showEditUserSuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showEditUserSuccessModal) return null;
    return (
        <AnimatePresence>
            {showEditUserSuccessModal && (
                <motion.div
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">User Updated Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
...
export default QmsEditUserSuccessModal
