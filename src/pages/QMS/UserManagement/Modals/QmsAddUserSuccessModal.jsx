...
const QmsAddUserSuccessModal = ({ showAddUserSuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showAddUserSuccessModal) return null;
    return (
        <AnimatePresence>
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">User Added Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
...
export default QmsAddUserSuccessModal
