...
const QmsDeleteUserErrorModal = ({ showDeleteUserErrorModal, onClose, error }) => {
    const { theme } = useTheme();

    if (!showDeleteUserErrorModal) return null;
    return (
        <AnimatePresence>
            {showDeleteUserErrorModal && (
                <motion.div
...
export default QmsDeleteUserErrorModal
