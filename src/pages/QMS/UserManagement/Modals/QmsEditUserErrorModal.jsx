...
const QmsEditUserErrorModal = ({ showEditUserErrorModal, onClose }) => {
    const { theme } = useTheme();

    if (!showEditUserErrorModal) return null;
    return (
        <AnimatePresence>
            {showEditUserErrorModal && (
                <motion.div
...
export default QmsEditUserErrorModal
