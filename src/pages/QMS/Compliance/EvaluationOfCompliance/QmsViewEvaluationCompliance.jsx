  ...
  const navigate = useNavigate();
    ...
    const handleCorrectionSubmit = async () => {
        try {
            ...
            const response = await axios.post(`${BASE_URL}/qms/evaluation/submit-correction/`, requestData);
    ...
    return (
        <div className="bg-[#1C1C24] p-5 rounded-lg">
            <div className='flex justify-between items-center border-b border-[#383840] pb-[26px]'>
                <h1 className='viewmanualhead'>Evaluation of Compliance/Obligation Information</h1>
