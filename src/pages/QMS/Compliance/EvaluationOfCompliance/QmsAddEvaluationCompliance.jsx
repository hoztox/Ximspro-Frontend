...
const QmsAddEvaluationCompliance = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.title.trim()) {
      newErrors.title = "Compliance/Obligation Name/Title is required";
    }
  ...
  const handleSaveClick = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${BASE_URL}/qms/evaluation-create/`,
        submitData,
        {
          headers: {
  ...
  const handleDraftClick = async () => {
    try {
      ...
      const response = await axios.post(
        `${BASE_URL}/qms/evaluation/draft-create/`,
        submitData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
      ...
      <div>
        <div className="flex items-center justify-between  px-[65px] 2xl:px-[122px]">
          <h1 className="add-manual-sections !px-0">
            Add Evaluation of Compliance/Obligation
          </h1>
          ...
          >
            <span>List Evaluation of Compliance/Obligation</span>
          </button>
        </div>
        ...
        <div className="border-t border-[#383840] mx-[18px] pt-[22px] px-[47px] 2xl:px-[104px]">
          <div className="grid md:grid-cols-2 gap-5">
            ...
            <div>
              <label className="add-qms-manual-label">Evaluation Remarks</label>
              <input
                type="text"
                name="remarks"
...
export default QmsAddEvaluationCompliance;
