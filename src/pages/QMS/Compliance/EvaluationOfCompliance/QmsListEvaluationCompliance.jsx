...
const QmsListEvaluationCompliance = () => {
  ...
  const handleConfirmDelete = async () => {
    if (manualToDelete) {
      try {
        await axios.delete(
          `${BASE_URL}/qms/evaluation-detail/${manualToDelete}/`
        );
  ...
  const handleQMSAddEvaluationCompliance = () => {
    navigate("/company/qms/add-evaluation-compliance");
  };
  ...
  const handlePublishSave = async () => {
    try {
      ...
      await axios.post(
        `${BASE_URL}/qms/evaluation/${selectedManualId}/publish-notification/`,
        {
  ...
  return (
    <div className="bg-[#1C1C24] list-manual-main">
      <div className="flex items-center justify-between px-[14px] pt-[24px]">
        <h1 className="list-manual-head">List Evaluation of Compliance</h1>
        ...
        <div className="flex space-x-5">
          ...
          >
            <span>Add Evaluation of Compliance</span>
            <img
              src={plusicon}
              alt="Add Icon"
              ...
              {paginatedManual.length > 0 ? (
                ...
                <tr>
                  <td colSpan="11" className="text-center py-4 not-found">
                    No Evaluation Compliance found.
                  </td>
                </tr>
              )}
              <tr>
...
export default QmsListEvaluationCompliance;
