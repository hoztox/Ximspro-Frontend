...
const ManualCorrectionSuccessModal = ({ showSentCorrectionSuccessModal, onClose }) => {
    const { theme } = useTheme();

    if (!showSentCorrectionSuccessModal) return null;
    return (
        <AnimatePresence>
            {showSentCorrectionSuccessModal && (
                <motion.div
                ...
                >
                    ...
                    >
                        ...
                        <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="success-messege">Correction Sent Successfully</p>
                        </div>
                    </motion.div>
                </motion.div>
            )}
...
export default ManualCorrectionSuccessModal
