...
const QmsDraftEvaluationCompliance = () => {
  ...
  const fetchManuals = async () => {
    try {
      ...
      const response = await axios.get(
        `${BASE_URL}/qms/evaluation-draft/${id}/`
      );
  ...
  return (
    <div className="bg-[#1C1C24] list-manual-main">
      ...
      <div className="flex items-center justify-between px-[14px] pt-[24px]">
        <h1 className="list-manual-head">Draft Evaluation Compliance</h1>
...
export default QmsDraftEvaluationCompliance;
