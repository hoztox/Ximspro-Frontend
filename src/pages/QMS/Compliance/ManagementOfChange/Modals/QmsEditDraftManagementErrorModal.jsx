...
const QmsEditDraftManagementErrorModal = ({ showDraftEditManagementErrorModal, onClose, error }) => {
  const { theme } = useTheme();

  if (!showDraftEditManagementErrorModal) return null;
  return (
    <AnimatePresence>
...
export default QmsEditDraftManagementErrorModal
