...
const QmsEditDraftManagementSuccessModal = ({ showDraftEditManagementSuccessModal, onClose }) => {
  const { theme } = useTheme();

  if (!showDraftEditManagementSuccessModal) return null;
  return (
    <AnimatePresence>
        ...
        >
          ...
          >
            ...
            <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
              ...
              <p className="success-messege">Management of Change Saved Successfully</p>
            </div>
          </motion.div>
        </motion.div>
      )}
...
export default QmsEditDraftManagementSuccessModal
