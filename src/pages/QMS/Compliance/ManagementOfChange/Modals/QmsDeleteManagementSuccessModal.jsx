...
const QmsDeleteManagementSuccessModal = ({ showDeleteManagementSuccessModal, onClose }) => {
  const { theme } = useTheme();

  if (!showDeleteManagementSuccessModal) return null;
  return (
    <AnimatePresence>
        ...
        >
          ...
          >
            ...
            <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
              ...
              <p className="success-messege">Management of Change Deleted Successfully</p>
            </div>
          </motion.div>
        </motion.div>
      )}
...
export default QmsDeleteManagementSuccessModal
