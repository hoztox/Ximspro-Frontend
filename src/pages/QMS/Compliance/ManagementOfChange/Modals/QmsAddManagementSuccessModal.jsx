...
const QmsAddManagementSuccessModal = ({ showAddManagementSuccessModal, onClose }) => {
  const { theme } = useTheme();

  if (!showAddManagementSuccessModal) return null;
  return (
    <AnimatePresence>
      {showAddManagementSuccessModal && (
        <motion.div
...
export default QmsAddManagementSuccessModal
