...
const QmsEditManagementSuccessModal = ({ showUpdatedManagementSuccessModal, onClose }) => {
  const { theme } = useTheme();

  if (!showUpdatedManagementSuccessModal) return null;
  return (
    <AnimatePresence>
      {showUpdatedManagementSuccessModal && (
        <motion.div
        ...
        >
          ...
          >
            ...
            <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
              ...
              <p className="success-messege">Management of Change Updated Successfully</p>
            </div>
          </motion.div>
        </motion.div>
      )}
...
export default QmsEditManagementSuccessModal
