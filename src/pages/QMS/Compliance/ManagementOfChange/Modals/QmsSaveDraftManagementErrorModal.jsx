...
const QmsSaveDraftManagementErrorModal =  ({ showDraftManagementErrorModal, onClose, error }) => {
  const { theme } = useTheme();

  if (!showDraftManagementErrorModal) return null;
  return (
    <AnimatePresence>
      {showDraftManagementErrorModal && (
        <motion.div
...
export default QmsSaveDraftManagementErrorModal
