...
const QmsSaveDraftManagementSuccessModal = ({ showDraftManagementSuccessModal, onClose }) => {
  const { theme } = useTheme();

  if (!showDraftManagementSuccessModal) return null;
  return (
    <AnimatePresence>
      {showDraftManagementSuccessModal && (
        <motion.div
        ...
        >
          ...
          >
            ...
            <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
              ...
              <p className="success-messege">Management of Change Drafted Successfully</p>
            </div>
          </motion.div>
        </motion.div>
      )}
...
export default QmsSaveDraftManagementSuccessModal
