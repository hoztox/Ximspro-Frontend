...
const QmsAddManagementErrorModal = ({ showAddManagementErrorModal, onClose, error }) => {
  const { theme } = useTheme();

  if (!showAddManagementErrorModal) return null;
  return (
    <AnimatePresence>
      {showAddManagementErrorModal && (
        <motion.div
...
export default QmsAddManagementErrorModal
