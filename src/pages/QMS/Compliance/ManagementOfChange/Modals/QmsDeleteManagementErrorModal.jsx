...
const QmsDeleteManagementErrorModal =({ showDeleteManagementErrorModal, onClose, error })  => {
  const { theme } = useTheme();

  if (!showDeleteManagementErrorModal) return null;
  return (
    <AnimatePresence>
      {showDeleteManagementErrorModal && (
        <motion.div
...
export default QmsDeleteManagementErrorModal
