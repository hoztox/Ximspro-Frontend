...
const QmsDraftManagementChange = () => {
  ...
  const handleEditManagementChange = () => {
    navigate("/company/qms/edit-draft-management-change");
  };

  const handleViewManagementChange = () => {
    navigate("/company/qms/view-draft-management-change");
  };
                ...
                {currentItems.map((item) => (
                  ...
                  >
                    ...
                    <td className="px-4 qms-list-compliance-data text-left">
                      <button onClick={handleEditManagementChange} className="text-[#1E84AF]">
                       Click to Continue
                      </button>
                    </td>
                    <td className="px-4 qms-list-compliance-data text-center">
                      <button onClick={handleViewManagementChange}>
                        <img
                          src={view}
                          alt="View Icon"
