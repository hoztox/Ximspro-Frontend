...
const QmsDeleteComplianceSuccessModal = ({ showDeleteComplianceSuccessModal, onClose }) => {
  const { theme } = useTheme();

  if (!showDeleteComplianceSuccessModal) return null;
  return (
    <AnimatePresence>
        ...
        >
          ...
          >
            ...
            <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
              ...
              <p className="success-messege">Compliance Deleted Successfully</p>
            </div>
          </motion.div>
        </motion.div>
      )}
...
export default QmsDeleteComplianceSuccessModal
