...
const QmsSaveDraftComplianceErrorModal =  ({ showDraftComplianceErrorModal, onClose, error }) => {
  const { theme } = useTheme();

  if (!showDraftComplianceErrorModal) return null;
  return (
    <AnimatePresence>
      {showDraftComplianceErrorModal && (
        <motion.div
...
export default QmsSaveDraftComplianceErrorModal
