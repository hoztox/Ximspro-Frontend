...
const QmsEditComplianceSuccessModal =  ({ showUpdatedComplianceSuccessModal, onClose }) => {
  const { theme } = useTheme();

  if (!showUpdatedComplianceSuccessModal) return null;
  return (
    <AnimatePresence>
        ...
        >
          ...
          >
            ...
            <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
              ...
              <p className="success-messege">Compliance Updated Successfully</p>
            </div>
          </motion.div>
        </motion.div>
      )}
...
export default QmsEditComplianceSuccessModal
