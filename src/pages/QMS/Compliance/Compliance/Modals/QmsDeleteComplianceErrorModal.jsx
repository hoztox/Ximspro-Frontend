...
const QmsDeleteComplianceErrorModal = ({ showDeleteComplianceErrorModal, onClose, error }) => {
  const { theme } = useTheme();

  if (!showDeleteComplianceErrorModal) return null;
  return (
    <AnimatePresence>
      {showDeleteComplianceErrorModal && (
        <motion.div
...
export default QmsDeleteComplianceErrorModal
