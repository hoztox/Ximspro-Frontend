...
const QmsAddComplianceErrorModal = ({ showAddComplianceErrorModal, onClose, error }) => {
  const { theme } = useTheme();

  if (!showAddComplianceErrorModal) return null;
  return (
    <AnimatePresence>
      {showAddComplianceErrorModal && (
        <motion.div
...
export default QmsAddComplianceErrorModal
