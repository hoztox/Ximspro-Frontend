...
const QmsEditComplianceErrorModal = ({ showUpdateComplianceErrorModal, onClose, error }) => {
  const { theme } = useTheme();

  if (!showUpdateComplianceErrorModal) return null;
  return (
    <AnimatePresence>
...
export default QmsEditComplianceErrorModal
