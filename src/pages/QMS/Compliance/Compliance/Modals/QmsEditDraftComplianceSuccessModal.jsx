...
const QmsEditDraftComplianceSuccessModal = ({ showDraftEditComplianceSuccessModal, onClose }) => {
 const { theme } = useTheme();
 
   if (!showDraftEditComplianceSuccessModal) return null;
   return (
     <AnimatePresence>
         ...
         >
           ...
           >
             ...
             <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
               ...
               <p className="success-messege">Compliance Saved Successfully</p>
             </div>
           </motion.div>
         </motion.div>
       )}
