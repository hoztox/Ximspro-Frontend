...
const QmsEditDraftComplianceErrorModal = ({ showDraftEditComplianceErrorModal, onClose, error }) => {
  const { theme } = useTheme();

  if (!showDraftEditComplianceErrorModal) return null;
  return (
    <AnimatePresence>
...
export default QmsEditDraftComplianceErrorModal
