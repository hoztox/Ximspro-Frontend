  ...
  const fetchDraftCount = async () => {
    try {
      ...
      const draftResponse = await axios.get(
        `${BASE_URL}/qms/legal/drafts-count/${id}/`
      );
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      setLegalRequirements(
        legalRequirements.filter((item) => item.id !== requirementsToDelete)
      );
      setShowDeleteModal(false);
      ...
      <div>
        <div className="flex justify-between items-center mb-6">
          <h1 className="list-compliance-head">
            List Legal and Other Requirements
          </h1>
        ...
        {isLoading ? (
          <div className="flex justify-center items-center h-40 not-found">
            <p>Loading data...</p>
          </div>
        ) : (
                ...
                <tbody>
                  {currentItems.length > 0 ? (
                    currentItems.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-4 qms-list-compliance-data text-center">
                          <button
                            onClick={() => handleViewLegalRequirements(item.id)}
                          >
                            <img
                              src={viewIcon}
                              alt="View Icon"
                        ...
                        <td className="px-4 qms-list-compliance-data text-center">
                          <button
                            onClick={() => handleEditLegalRequirements(item.id)}
                          >
                            <img
                              src={editIcon}
                              alt="Edit icon"
                    ...
                    <tr>
                      <td
                        colSpan="9"
                        className="px-4 py-4 text-center not-found"
                      >
