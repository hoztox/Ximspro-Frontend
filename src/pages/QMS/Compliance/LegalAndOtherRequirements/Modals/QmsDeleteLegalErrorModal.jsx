...
const QmsDeleteLegalErrorModal = ({ showDeleteLegalErrorModal, onClose, error }) => {
 const { theme } = useTheme();
 
   if (!showDeleteLegalErrorModal) return null;
   return (
     <AnimatePresence>
       {showDeleteLegalErrorModal && (
         <motion.div
...
export default QmsDeleteLegalErrorModal
