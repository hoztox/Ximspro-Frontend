...
const QmsEditDraftLegalSuccessModal = ({ showDraftEditLegalSuccessModal, onClose }) => {
  const { theme } = useTheme();
  
    if (!showDraftEditLegalSuccessModal) return null;
    return (
      <AnimatePresence>
        {showDraftEditLegalSuccessModal && (
          <motion.div
          ...
          >
            ...
            >
              ...
              <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                ...
                <p className="success-messege">Requirements Saved Successfully</p>
              </div>
            </motion.div>
          </motion.div>
        )}
...
export default QmsEditDraftLegalSuccessModal
