...
const QmsEditDraftLegalErrorModal = ({ showDraftEditLegalErrorModal, onClose, error }) => {
  const { theme } = useTheme();
 
   if (!showDraftEditLegalErrorModal) return null;
   return (
     <AnimatePresence>
       {showDraftEditLegalErrorModal && (
         <motion.div
...
export default QmsEditDraftLegalErrorModal
