...
const QmsAddLegalSuccessModal = ({ showAddLegalSuccessModal, onClose }) => {
  const { theme } = useTheme();

  if (!showAddLegalSuccessModal) return null;
  return (
    <AnimatePresence>
      {showAddLegalSuccessModal && (
        <motion.div
        ...
        >
          ...
          >
            ...
            <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
              ...
              <p className="success-messege">Legal Requirements Added Successfully</p>
            </div>
          </motion.div>
        </motion.div>
      )}
...
export default QmsAddLegalSuccessModal
