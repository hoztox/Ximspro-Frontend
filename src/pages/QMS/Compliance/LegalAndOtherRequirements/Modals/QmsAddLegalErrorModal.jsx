...
const QmsAddLegalErrorModal = ({ showAddLegalErrorModal, onClose, error }) => {
  const { theme } = useTheme();
 
   if (!showAddLegalErrorModal) return null;
   return (
     <AnimatePresence>
       {showAddLegalErrorModal && (
         <motion.div
...
export default QmsAddLegalErrorModal
