...
const QmsEditLegalSuccessModal = ({ showUpdatedLegalSuccessModal, onClose }) => {
  const { theme } = useTheme();

  if (!showUpdatedLegalSuccessModal) return null;
  return (
    <AnimatePresence>
      {showUpdatedLegalSuccessModal && (
        <motion.div
        ...
        >
          ...
          >
            ...
            <div className={`success-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
              ...
              <p className="success-messege">Legal Requirements Updated Successfully</p>
            </div>
          </motion.div>
        </motion.div>
      )}
...
export default QmsEditLegalSuccessModal
