...
const QmsSaveDraftLegalErrorModal =  ({ showDraftLegalErrorModal, onClose, error }) => {
  const { theme } = useTheme();

  if (!showDraftLegalErrorModal) return null;
  return (
    <AnimatePresence>
      {showDraftLegalErrorModal && (
        <motion.div
...
export default QmsSaveDraftLegalErrorModal
