...
const QmsSaveDraftLegalSuccessModal = ({ showDraftLegalSuccessModal, onClose }) => {
  const { theme } = useTheme();

  if (!showDraftLegalSuccessModal) return null;
  return (
    <AnimatePresence>
      {showDraftLegalSuccessModal && (
        <motion.div
...
export default QmsSaveDraftLegalSuccessModal
