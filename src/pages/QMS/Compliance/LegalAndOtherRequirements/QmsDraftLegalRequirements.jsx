...
const QmsDraftLegalRequirements = () => {
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      setComplianceData(
        complianceData.filter((item) => item.id !== requirementsToDelete)
      );
      setShowDeleteModal(false);
  ...
  const filteredData = complianceData.filter(
    (item) =>
      ...
      (item.complianceNo?.toLowerCase() || "").includes(
  ...
  if (loading)
    return (
      <div className="bg-[#1C1C24] not-found p-5 rounded-lg text-center">
        Loading...
      </div>
    );
    ...
    <div className="bg-[#1C1C24] text-white p-5 rounded-lg">
      <div>
        <div className="flex justify-between items-center mb-6">
          <h1 className="list-compliance-head">
            Draft Legal and Other Requirements
          </h1>
              ...
              <tbody>
                {currentItems.length > 0 ? (
                  currentItems.map((item, index) => (
                    ...
                    >
                      ...
                      <td className="px-4 qms-list-compliance-data text-left">
                        <button
                          onClick={() =>
                            handleEditDraftLegalRequirements(item.id)
                          }
                      ...
                      <td className="px-4 qms-list-compliance-data text-center">
                        <button
                          onClick={() =>
                            handleViewDraftLegalRequirements(item.id)
                          }
                        >
                          <img
                            src={view}
                  ...
                  <tr className="border-b border-[#383840]">
                    <td colSpan="9" className="px-4 py-3 text-center not-found">
