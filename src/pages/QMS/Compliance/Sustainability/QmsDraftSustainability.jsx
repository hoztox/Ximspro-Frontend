  ...
  const fetchManuals = async () => {
    try {
      ...
      const response = await axios.get(
        `${BASE_URL}/qms/sustainability-draft/${id}/`
      );
  ...
  return (
    <div className="bg-[#1C1C24] list-manual-main">
      ...
      <div className="flex items-center justify-between px-[14px] pt-[24px]">
        <h1 className="list-manual-head">Draft Sustainability</h1>
      ...
      <div className="p-5 overflow-hidden">
        {loading ? (
          <div className="text-center py-4 text-white not-found">
...
export default QmsDraftSustainability;
