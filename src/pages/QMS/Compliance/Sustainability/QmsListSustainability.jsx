...
const QmsListSustainability = () => {
  ...
  const fetchManuals = async () => {
    try {
      ...
      const response = await axios.get(
        `${BASE_URL}/qms/sustainability/${companyId}/`
      );
    ...
    const fetchAllData = async () => {
      try {
        ...
        const correctionsPromises = filteredManuals.map(async (manual) => {
          try {
            ...
            const correctionResponse = await axios.get(
              `${BASE_URL}/qms/sustainability/${manual.id}/corrections/`
            );
            console.log(
        ...
        const draftResponse = await axios.get(
          `${BASE_URL}/qms/sustainability/drafts-count/${id}/`
        );
  ...
  const handleConfirmDelete = async () => {
    if (manualToDelete) {
      try {
        await axios.delete(
          `${BASE_URL}/qms/sustainability-detail/${manualToDelete}/`
        );
  ...
  const handlePublishSave = async () => {
    try {
      ...
      await axios.post(
        `${BASE_URL}/qms/sustainability/${selectedManualId}/publish-notification/`,
        {
