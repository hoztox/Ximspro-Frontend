...
const QmsEditDraftSustainability = () => {
  ...
  const handleUpdateClick = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `${BASE_URL}/qms/sustainability/create/${id}/`,
        submitData,
        {
          headers: {
  ...
  return (
    <div className="bg-[#1C1C24] rounded-lg text-white">
      <div>
        <h1 className="add-manual-sections">Sustainability Draft</h1>
...
export default QmsEditDraftSustainability;
