...
const QmsAddSustainability = () => {
  ...
  const handleSaveClick = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${BASE_URL}/qms/sustainability-create/`,
        submitData,
        {
          headers: {
  ...
  const handleDraftClick = async () => {
    try {
      ...
      const response = await axios.post(
        `${BASE_URL}/qms/sustainability/draft-create/`,
        submitData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
    ...
    <div className="bg-[#1C1C24] rounded-lg text-white">
      <div>
        <div className="flex items-center justify-between  px-[65px] 2xl:px-[122px]">
          <h1 className="add-manual-sections !px-0">Add Sustainability</h1>
        ...
        <div className="border-t border-[#383840] mx-[18px] pt-[22px] px-[47px] 2xl:px-[104px]">
          <div className="grid md:grid-cols-2 gap-5">
            ...
            <div>
              <label className="add-qms-manual-label">
                Relate Document / Guideline / Process
              </label>
              <input
                type="text"
...
export default QmsAddSustainability;
