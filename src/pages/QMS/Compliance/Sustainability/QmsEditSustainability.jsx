...
const QmsEditSustainability = () => {
  ...
  try {
    ...
    console.error("Error updating sustainability:", err);
  }
};
    ...
    <div className="bg-[#1C1C24] rounded-lg text-white">
      <div>
        <div className="flex items-center justify-between  px-[65px] 2xl:px-[122px]">
          <h1 className="add-manual-sections !px-0">Edit Sustainability</h1>

          <button
            className="flex items-center justify-center !w-[195px]  add-manual-btn gap-[10px] duration-200 border border-[#858585] text-[#858585] hover:bg-[#858585] hover:text-white"
            onClick={handleListEvaluationCompliance}
          >
            <span>List Sustainability</span>
          </button>
        </div>
        ...
        <div className="border-t border-[#383840] mx-[18px] pt-[22px] px-[47px] 2xl:px-[104px]">
          <div className="grid md:grid-cols-2 gap-5">
            ...
            <div>
              <label className="add-qms-manual-label">
                Relate Document / Guidelines / Process
              </label>
              <input
                type="text"
...
export default QmsEditSustainability;
