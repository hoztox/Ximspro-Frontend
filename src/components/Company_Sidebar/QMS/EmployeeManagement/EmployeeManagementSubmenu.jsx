...
const EmployeeManagementSubmenu = (props) => {
   ...
   const categories = [
     {
       ...
       path: "/company/qms/add-employee",
     },
     {
       id: "listemployee",
       label: "List Employee",
       icon: <img src={manual} alt="Manual" className="w-[15px] h-[15px]" />,
       path: "/company/qms/list-employee",
       relatedPaths: [
        "/company/qms/edit-employee",
        "/company/qms/view-employee",
      ],
     },
   ];
   ...
   const handleCategoryClick = (category) => {
     if (props && props.handleItemClick) {
       // Pass "qmsemployee" as the parent menu ID instead of true
       props.handleItemClick(category.id, category.path, "qmsemployee");
     } else {
...
export default EmployeeManagementSubmenu
