...
const EnergyManagementSubmenu = (props) => {
  ...
  const categories = [
    ...
    },
    {
      ...
      relatedPaths: [
        "/company/qms/add-energy-action-plan",
        "/company/qms/edit-energy-action-plan",
        "/company/qms/view-energy-action-plan",
        "/company/qms/draft-energy-action-plan",
        "/company/qms/edit-draft-energy-action-plan",
        "/company/qms/view-draft-energy-action-plan",
      ],
    },
  ];
