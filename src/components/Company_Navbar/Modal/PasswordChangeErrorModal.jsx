...
const PasswordChangeErrorModal = ({ showPasswordErrorModal, onClose }) => {
    const { theme } = useTheme();

    if (!showPasswordErrorModal) return null;
    return (
        <AnimatePresence>
                ...
                >
                    ...
                    >
                        ...
                        <div className={`add-cmy-error-modal-content flex flex-col items-center justify-center ${theme === "dark" ? "dark" : "light"}`}>
                            ...
                            <p className="add-cmy-error-messege">Incorrect Password</p>
